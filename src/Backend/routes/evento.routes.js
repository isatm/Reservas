...
import { crearEvento, obtenerEvento, obtenerEventoPorId, crearReserva, obtenerReservasUsuario, filtrar, modificarEvento, eliminarEvento } from '../controllers/evento.controller.js';
...
router.put('/eventos/:id', verificarToken, modificarEvento);
